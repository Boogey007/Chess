...
function calculateAnimations(pos1, pos2) {
  ...
  for (var i in pos1) {
    ...
    // do not clear a piece if it is on a square that is the results
...
function stopDraggedPiece(location) {
  ...
  if (cfg.hasOwnProperty('onDrop') === true &&
    ...
    var results = cfg.onDrop(DRAGGED_PIECE_SOURCE, location, DRAGGED_PIECE,
      newPosition, oldPosition, CURRENT_ORIENTATION);
    if (results === 'snapback' || results === 'trash') {
      action = results;
    }
  }
