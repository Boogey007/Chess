<?php
    ...
    if ( !empty($_POST)) {
        ...
        if ($valid) {
            ...
            $sql = "UPDATE chessgames  set info = ?, white = ?, black =?, pgn =?, fen =?, comments =?, results =? WHERE id = ?";
            $q = $pdo->prepare($sql);
            $q->execute(array(htmlspecialchars($info),
                              ...
                              htmlspecialchars($comments), htmlspecialchars($results), htmlspecialchars($id)));
            Database::disconnect();
...
<html lang="en">
    ...
    <style>
      ...
      font-family:monospace;
        ...
        function copymove(){
            ...
            document.getElementById("resultsinput").value = score;
        }
  ...
  <body>
      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav nav-pills">
            ...
            <li><a href="#" style="color: #ff726f"onclick="reset()">Clear</a></li>			
          </ul>
        </div>
      </div>
    </nav>
    ...
    <div class="container">
                        <div class="row">
                            <div class="col-md-5">
                                <h4><small style="color:#0077ff;"><?php echo !empty($info)?$info:'';?>:&nbsp;</small>
                                    <?php echo !empty($white)?$white:'';?>&nbsp;<small style="color:#0077ff;">against</small>&nbsp;
                    ...
                    <div class="row">
                            <div class="col-md-5">
                                ...
                                <div id="gamecontrol">
<a class="btn btn-default" onclick="gameBack()"><span class="glyphicon glyphicon-chevron-left" aria-hidden="true"></span> Prev.</a>
								  ...
								  <br>
								  <a class="btn btn-info" onclick="flipboard()" style="display:none;"><span class="glyphicon glyphicon-refresh" aria-hidden="true">Revert</a>
								</div>
							</div>
							<div class="col-md-4">
								<span><label>chessboard:</label><br><span id="pgn"></span></span>
								...
								<div style="display:none">
									<label class="u-full-width">results</label>
									<div class="u-full-width">
											<input name="results" type="text"  id="resultsinput" placeholder="results" value="<?php echo !empty($results)?$results:'';?>">
									</div>
								</div>
								...
								<div class="u-full-width">
									...
									<span ><label>Notation</label><br></span>
											<textarea name="pgn" class="form-control" id="pgninput" placeholder="Copy above 'chessboard' notation in here before the save"><?php echo !empty($pgn)?$pgn:'';?></textarea>
									<span style="display:none"><label>Notation fen</label><br></span>

											<textarea style="display:none" name="fen" class="form-control" id="feninput" placeholder="fen"><?php echo !empty($fen)?$fen:'';?></textarea>
									<span><label>Comments</label><br></span>
		...
		<script language="javascript" type="text/javascript">
		    ...
		    var onDrop = function(source, target) {
		      var move = game.move({
		        from: source,
		        to: target,
		        promotion: 'q' // NOTE: ajust alwasy give queen
		      });
